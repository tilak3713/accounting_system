...
?>
    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4">
                ...
                <div class="card-body">
                     {{Form::open(['method'=>'post', 'url'=>'purchase/update_purchase_order/'.$data[0]->id])}}
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{__('Purchase Order')}}</label>
                         <div class="col-md-6">
                            ...
                            {{Form::text('',$data[0]->id, ['class'=>'form-control','readonly'])}}
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{__('Supplier Name')}}</label>
                         <div class="col-md-6">
                            ...
                            {{Form::select('po_supplier_name', array('1'=>'Choose Supplier Name','2'=>'THO'), '',['class'=>'form-control','required'=>'','autocomplete'=>'po_supplier_name','autofocus'=>''])}}
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            {{Form::text('po_narration',$data[0]->po_narration, ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Narration','autocomplete'=>'po_narration','autofocus'=>''])}}
        ...
        <div class="card-header py-3">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Add New Purchase item for Purchase Order No: {{'THO-'.$data[0]->id}}</h6>
                </div>
                <div class="card-body">
            ...
            <table class="table table-bordered"  width="100%" cellspacing="0">
                <thead>
                    <tr>                        
                        ...
                        <th>Amount (AUD)</th>
                        <th><input type="button" class="btn btn-primary" onclick="add_more()" value="Add More +"></th>
                    ...
                    <tbody>
                     @foreach($data as $result)
                        ...
                        <tr class="social_icon_fields">
                            <td>{{Form::text('items[0][pi_booking_reference]',$result->pi_booking_reference, ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Booking Reference','autocomplete'=>'pi_booking_reference','autofocus'=>''])}}
                            ...
                            <td>{{Form::text('items[0][pi_supplier_amount]',$result->pi_supplier_amount, ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Supplier Currency Amount','autocomplete'=>'pi_supplier_amount','autofocus'=>''])}}
                            ...
                            <td>{{Form::text('items[0][pi_amount]',$result->pi_amount, ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Amount','autocomplete'=>'po_amount','autofocus'=>''])}}
