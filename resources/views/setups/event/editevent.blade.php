 ...
 <div class="row">
    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4">
                ...
                <div class="card-body">
                 {{Form::open(['method'=>'post', 'url'=>'setups/event/update_event/'.$data->id])}}
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{__('Event Date')}}</label>
                         <div class="col-md-4">
                           
                            {{Form::date('event_date',$data->event_date, ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Contact Name','autocomplete'=>'event_date','autofocus'=>''])}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            {{Form::text('event_name',$data->event_name, ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Event Name','autocomplete'=>'event_name','autofocus'=>''])}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            {{Form::textarea('event_description',$data->event_description, ['class'=>'form-control', 'required'=>'','placeholder'=>'Write Event Description...','autocomplete'=>'event_description','autofocus'=>''])}}
