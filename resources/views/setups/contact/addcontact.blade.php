 ...
 <div class="row">
    ...
    <div class="col-lg-12">
		<div class="card shadow mb-4">
                ...
                <div class="card-body">
                 {{Form::open(['method'=>'post', 'url'=>'setups/contact/insert_contact'])}}
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{__('Contact Name')}}</label>
                         <div class="col-md-4">
                           
                            {{Form::text('contact_name','', ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Contact Name','autocomplete'=>'contact_name','autofocus'=>''])}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            {{Form::text('contact_phone','', ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Phone No.','autocomplete'=>'contact_phone','autofocus'=>''])}}
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{__('Contact Mobile No.')}}</label>
                         <div class="col-md-4">
                            ...
                            {{Form::text('contact_mobile','', ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Mobile No.','autocomplete'=>'contact_mobile','autofocus'=>''])}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            {{Form::textarea('contact_address','', ['class'=>'form-control', 'required'=>'','placeholder'=>'Enter Your full Address.','autocomplete'=>'contact_address','autofocus'=>''])}}
