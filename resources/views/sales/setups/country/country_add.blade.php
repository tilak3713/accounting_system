            ...
            <div class="card-body">
                {{ Form::open(array('url'=>'/setups/country/store'))}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('currency_code','',['class'=>'form-control']) }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('currency_symbol','',['class'=>'form-control']) }}
