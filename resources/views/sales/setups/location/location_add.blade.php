                ...
                {{ Form::open(array('url'=>'/setups/location/store'))}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            {{ Form::select('region',$region_data,'',['class'=>'form-control']) }}
