            ...
            <div class="card-body">
                {{ Form::open(array('url'=>'/sales/invoice-items/edit/'.$data->id))}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            {{ Form::checkbox('is_tour','1',$data->is_tour,array('style'=>'width:31px;height:36px;')) }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            {{ Form::checkbox('exclude_from_discounts','1',$data->exclude_from_discounts,array('style'=>'width:31px;height:36px;')) }}
