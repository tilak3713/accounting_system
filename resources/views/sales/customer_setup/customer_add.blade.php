...
<div class="row">
    ...
    <div class="col-md-12 ">
        ...
        <div class="card mb-4">  
            ...
            <div class="card-body">
                {{ Form::open(array('url'=>'/sales/customers/store'))}}
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            {{ Form::select('title',$title,'',['class'=>'form-control']) }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            {{ Form::select('location_id_fk',$location_data,'',['class'=>'form-control']) }}
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            {{ Form::textarea('additional_info','',['class'=>'form-control','rows'=>4,'cols'=>4]) }}
