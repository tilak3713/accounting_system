                ...
                <form method="POST" action="{{ url('expense/edit/save') }}" name="expense_form">
                    ...
                    {{Form::hidden('id', $expense[0]->id)}}
                     <div class="form-group row">
                        ...
                        <div class="col-md-6">                           
                            {{ Form::select('cash_or_bank_ac', array(''=>'Please Select')+$cashOrBankAccounts, $expense[0]->cash_or_bank_ac, array('class' => 'form-control'))}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">                           
                            {{ Form::text('narration', $expense[0]->narration, array('class'=>'form-control', 'placeholder'=>'Enter Narration.'))}}
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-6">                           
                            {{ Form::select('account', array(''=>'Please Select')+$expenseAccount, $expense[0]->account, array('class' => 'form-control'))}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">                           
                            {{Form::text('amount_without_tax', $expense[0]->amount_without_tax, array('class'=>'form-control', 'autocomplete'=>'off', 'placeholder'=>'Amount', 'id'=>'expense_amount_without_tax'))}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">                           
                            {{ Form::select('tax_type', array(''=>'Please Select')+$tax_type, $expense[0]->tax_type, array('class' => 'form-control', 'id'=>'expense_tax_type'))}}
