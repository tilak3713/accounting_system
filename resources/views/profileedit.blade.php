...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="card mb-4">  
            ...
            <div class="card-body">
                <form method="POST" action="{{ url('user/profile/save') }}">
                    @csrf
 ...
 <input name="id" value="{{$user[0]->id}}" type="hidden">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id=old"password" type="password" class="form-control @error('oldpassword') is-invalid @enderror" name="oldpassword" required autocomplete="old-password">
                            @error('oldpassword')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
