...
<div class="row">
    <div class="col-lg-10">
        ...
        <div class="card mb-4">  
            ...
            <div class="card-body">
                <form method="POST" action="{{ url('tax/new/save') }}" name="tax_form">
                    @csrf                  
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Tax type code') }}</label>
                        <div class="col-md-6">                           
                            {{ Form::text('tax_type_code', '', array('class'=>'form-control', 'placeholder'=>'Enter tax type code.'))}}
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-6">                           
                            {{ Form::text('tax_type_name', '', array('class'=>'form-control', 'placeholder'=>'Enter tax type name.'))}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">                           
                            {{ Form::text('tax_rate', '0', array('class'=>'form-control', 'placeholder'=>'Enter tax rate.'))}}
