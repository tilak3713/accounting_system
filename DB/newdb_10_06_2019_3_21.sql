...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2019 at 11:50 AM
...
(3, 'sadas', 1, '0', NULL, 0, 1, 0, 0, 0, 1, 'asdasdasd', '2019-06-10 12:36:58', '2019-06-10 12:36:58'),
(4, 'client account', 1, '0', NULL, 0, 1, 0, 0, 0, 1, 'sdfsdfsd fsd fsd', '2019-06-10 12:44:01', '2019-06-10 12:44:01'),
(5, 'supplier account 1', 1, '0', NULL, 0, 0, 0, 1, 0, 1, 'sdfsd', '2019-06-10 14:34:42', '2019-06-10 14:34:42');

-- --------------------------------------------------------

--
-- Table structure for table `accounts_discount`
--

CREATE TABLE `accounts_discount` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `discount_period` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `accounts_discount`
--

INSERT INTO `accounts_discount` (`id`, `discount_period`, `account_name`, `discount_type`, `created_at`, `updated_at`) VALUES
(98, '3', 'S', 1, '2019-06-10 05:48:01', '2019-06-10 05:48:01'),
(99, '1', 'S', 1, '2019-06-10 06:28:25', '2019-06-10 06:28:25'),
(100, '2', 'L', 1, '2019-06-10 06:55:19', '2019-06-10 09:24:19'),
(101, '2', 'S', 1, '2019-06-10 08:22:51', '2019-06-10 08:22:51'),
(102, '1', 'L', 1, '2019-06-10 09:45:38', '2019-06-10 09:45:38');
...
(4, 'Ranjan Kumar', '8470029133', '9122713468', 's', '2019-05-30 06:34:22', '2019-05-30 06:34:22'),
(5, 'Ranjan Kumar', '8470029133', '9122713468', 'dddd dsf sdf', '2019-05-30 06:39:35', '2019-06-10 04:08:58'),
(6, 'xcv', 'xc', 'sd', 'sd', '2019-06-10 09:31:38', '2019-06-10 09:31:38');
...
(2, 'Mr', 'Anand sd', 'anand@gmail.com', '9876543210', '4', 2, '2', 'hiii', NULL, '2019-06-04 11:05:12', '2019-06-10 13:48:38'),
(4, 'Mr', 'Prashant', 'prashant@gmail.com', '9876543277', '3', 2, '12', 'hi', NULL, '2019-06-04 12:52:12', '2019-06-04 12:52:12');
...
CREATE TABLE `discount_item` (
  ...
  `account_discount_id` int(64) NOT NULL,
  `item_description` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `discount_amount` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `discount_percent` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `discount_item` (`id`, `account_discount_id`, `item_description`, `discount_amount`, `discount_percent`, `created_at`, `updated_at`) VALUES
(2, 91, '3021', '23123', 'asdasd', '2019-06-07 08:18:11', '2019-06-07 08:18:11'),
(3, 92, '3025', '23123', 'asdasd', '2019-06-07 08:19:24', '2019-06-07 08:19:24'),
(4, 94, '3021', '23123', '123123', '2019-06-07 08:45:21', '2019-06-07 08:45:21'),
(6, 94, '3021', '23123', '123123', '2019-06-07 08:45:38', '2019-06-07 08:45:38'),
(7, 94, '3021', '23123', '123123', '2019-06-07 08:45:41', '2019-06-07 08:45:41'),
(8, 94, '3021', '23123', '123123', '2019-06-07 08:45:44', '2019-06-07 08:45:44'),
(25, 98, '3019', '23123', 'b', '2019-06-10 05:48:08', '2019-06-10 05:48:08'),
(26, 99, '3021', '23123', 'asdasd', '2019-06-10 06:28:34', '2019-06-10 06:28:34'),
(27, 98, '3020', 'b', 'asdasd', '2019-06-10 07:27:05', '2019-06-10 07:27:05'),
(28, 100, '3020', '23123', 'asdasd', '2019-06-10 08:35:16', '2019-06-10 08:35:16'),
(29, 100, '3020', '23123', 'asdasd', '2019-06-10 08:35:21', '2019-06-10 08:35:21'),
(30, 98, '3020', '23123', '123123', '2019-06-10 08:36:07', '2019-06-10 08:36:07'),
(31, 98, '3022', 'b', '12', '2019-06-10 08:36:59', '2019-06-10 08:36:59'),
(32, 98, '3019', '23123', 'yt', '2019-06-10 08:37:48', '2019-06-10 08:37:48'),
(33, 98, '3028', 'a', 'wetewr', '2019-06-10 08:39:47', '2019-06-10 08:39:47'),
(34, 98, '3020', '23123', '123123', '2019-06-10 08:41:12', '2019-06-10 08:41:12'),
(35, 98, '3020', 'bm', 'jvjh', '2019-06-10 08:42:03', '2019-06-10 08:42:03'),
(36, 98, '3021', '23123', 'b', '2019-06-10 08:44:50', '2019-06-10 08:44:50'),
(37, 98, '3022', 'b', 'b', '2019-06-10 08:45:15', '2019-06-10 08:45:15'),
(38, 98, '3022', 'b', 'b', '2019-06-10 08:46:06', '2019-06-10 08:46:06'),
(39, 98, '3026', 's', 's', '2019-06-10 08:50:04', '2019-06-10 08:50:04'),
(40, 98, '3021', '23123', 'asdasd', '2019-06-10 08:52:07', '2019-06-10 08:52:07'),
(41, 98, '3022', 'dsf', 'sd', '2019-06-10 08:53:39', '2019-06-10 08:53:39'),
(42, 98, '3020', 'b', 's', '2019-06-10 08:54:47', '2019-06-10 08:54:47'),
(43, 100, '3020', 'b', '123123', '2019-06-10 09:25:35', '2019-06-10 09:25:35'),
(44, 100, '3020', 'b', '123123', '2019-06-10 09:25:49', '2019-06-10 09:25:49'),
(45, 100, '3020', 'jhvhvj', 'jbjvhvj', '2019-06-10 09:48:28', '2019-06-10 09:48:28'),
(46, 102, '3021', 'mjkbj', 'jbjk', '2019-06-10 09:49:39', '2019-06-10 09:49:39'),
(47, 100, '3021', 'jhvhvj', 'jb', '2019-06-10 09:50:04', '2019-06-10 09:50:04');
...
CREATE TABLE `discount_periods` (
  ...
  `sales_budget` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `discount_periods` (`id`, `description`, `start_date`, `end_date`, `sales_budget`, `company_id`, `created_at`, `updated_at`) VALUES
(1, 'anand', '2019-06-03 18:30:00', '2019-06-04 18:30:00', 'above 12 %', NULL, '2019-06-04 11:43:27', '2019-06-04 11:43:27'),
(2, 'tilak', '2019-06-19 18:30:00', '2019-07-10 18:30:00', 'above 12 %', NULL, '2019-06-04 11:47:23', '2019-06-04 11:47:23'),
(3, 'tilak', '2019-06-19 18:30:00', '2019-07-10 18:30:00', 'above 12 %', NULL, '2019-06-04 11:47:29', '2019-06-04 11:47:29');
...
(3, '2020-12-26', 'Justin Bieber Concert', 'Full Masti and Party krenge dfssd', '2019-05-31 16:52:47', '2019-06-10 09:39:10');
...
INSERT INTO `invoice_items` (`id`, `item_name`, `created_at`, `updated_at`) VALUES
(3019, 'Brianne Kuhic', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3020, 'Misael Wisoky', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3021, 'Destin Gaylord', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3022, 'Amalia Mueller', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3023, 'Lemuel Schowalter', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3024, 'Modesto Goodwin', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3025, 'Jerrod Corwin', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3026, 'Mr. Angel Hackett', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3027, 'Ms. Nikita Walter', '2019-06-06 08:52:56', '2019-06-06 08:52:56'),
(3028, 'Dr. Kathleen O\'Conner IV', '2019-06-06 08:52:56', '2019-06-06 08:52:56');
...
(3, '3', 'hr', '789456123', '789456123', '2019-06-07 00:51:20', '2019-06-07 00:51:20'),
(4, '4', 'hr', '150258', '12300', '2019-06-07 05:02:43', '2019-06-07 05:02:43'),
(5, '4', 'THOU', '15000', '1500', '2019-06-07 05:02:43', '2019-06-07 05:02:43'),
(6, '4', 'saasas', '856523', '5542', '2019-06-07 05:02:43', '2019-06-07 05:02:43'),
(7, '5', 'hr', '7854242', '4144', '2019-06-07 05:04:29', '2019-06-07 05:04:29'),
(8, '5', 'THOU', '244224', '42424', '2019-06-07 05:04:29', '2019-06-07 05:04:29');
...
(4, '2019-06-06 13:00:00', '1', '1', '2019-06-06 13:00:00', '1.00', '1.00', 'IN', '2019-06-07 05:02:43', '2019-06-07 05:02:43'),
(5, '2019-06-06 13:00:00', '1', '1', '2019-06-06 13:00:00', '1.00', '1.00', 'IN', '2019-06-07 05:04:29', '2019-06-07 05:04:29'),
...
(2, 'skdhfksjdfkshdj', 'newone', '2', '2019-06-10 13:43:14', '2019-06-10 13:43:14');
...
--
-- Indexes for table `accounts_discount`
--
ALTER TABLE `accounts_discount`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `discount_periods`
--
ALTER TABLE `discount_periods`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `region_setup`
--
ALTER TABLE `region_setup`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `accounts_discount`
--
ALTER TABLE `accounts_discount`
...
--
-- AUTO_INCREMENT for table `country_setup`
--
ALTER TABLE `country_setup`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `customer_setup`
--
ALTER TABLE `customer_setup`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `discount_periods`
--
ALTER TABLE `discount_periods`
...
--
ALTER TABLE `invoice_items`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3029;

--
-- AUTO_INCREMENT for table `location_setup`
--
ALTER TABLE `location_setup`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `region_setup`
--
ALTER TABLE `region_setup`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
